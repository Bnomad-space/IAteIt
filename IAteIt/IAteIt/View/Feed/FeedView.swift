...
struct FeedView: View {
    ...
    var body: some View {
        ...
        .fullScreenCover(isPresented: self.$signUpState.isPresent, content: {
            SignUpView(loginState: loginState, signUpState: signUpState, userIdentifier: loginState.appleUid)
        })
    }
}
